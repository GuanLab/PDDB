...
def network(input_var, label_var, shape):
    ...
    layer = DenseLayer(layer, num_units=256,nonlinearity=nn.nonlinearities.sigmoid) 
    layer = DenseLayer(layer, num_units=128,nonlinearity=nn.nonlinearities.sigmoid) 
